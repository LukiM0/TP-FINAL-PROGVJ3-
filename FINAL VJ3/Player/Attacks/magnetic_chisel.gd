...
var spr_chis_reg = preload("res://Textures/Weapons/MagneticChisel.png")
var spr_chis_attack = preload("res://Textures/Weapons/MagneticChiselAttack.png")
...
@onready var resetPauseTimer = get_node("%ResetPosTimer")
@onready var snd = $snd_attack
...
func enable_attack(atk = true):
	if atk:
		...
		sprite.texture = spr_chis_attack
	else:
		collision.call_deferred("set", "disabled", true)
		sprite.texture = spr_chis_reg
